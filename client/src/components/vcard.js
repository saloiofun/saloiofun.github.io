        ...
        <CardContent className={classes.content}>
          <Grid container spacing={24}>
            <Grid item xs={12} md={7}>
              ...
              I'm <span className={classes.name}>Sandro Wong</span> and I'm passionate about Web Development. I recently graduated from a 6 months Coding Bootcamp learning Full Stack Web Development and I'm eager to put my skills in practice. Throughout the years, I've earned a reputation for quality and efficiency in customer satisfaction, communication, and problem resolution. I'm a fast learner, team player, and hard worker, able to build a sophisticated website with full database backend all the way from mockup to rollout.
              </Typography>
